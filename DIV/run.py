...
if __name__ == "__main__":
    ...
    if args.type == 'inference':
        os.system("python3 DIV/%s/run.py --shot %d --complexity %d --eval %s"%(args.type, args.shot, args.complexity, args.eval))
    elif args.type == 'finetune':
        os.system("python3 DIV/%s/run.py --shot %d --complexity_fact %d --eval %s"%(args.type, args.shot, args.complexity_fact, args.eval))
